...
public class NiceAlarm extends JFrame implements ActionListener {
	 private static final long serialVersionUID = 1L;
	    ...
	    JLabel Label_Tips = new JLabel("设置一个时间: ");
	    JLabel Label_H = new JLabel("时 : ");
	    JLabel Label_M = new JLabel("分 : ");
	    ...
	    public void actionPerformed(ActionEvent e) {
	        ...
	        if (e.getSource() == Textfield_H) {
	            NL.Label_Alarm.setText("闹钟: " + Textfield_H.getText() + ":" + Textfield_M.getText());
